            ...
            databaseReference.child("users").child(post.uid).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.getValue() != null) {
                        ...
                        /*storageReference.child(userModel._profileImage).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            @Override
                            public void onSuccess(Uri uri) {
                                mGlideRequestManager.load(uri)
                                        .signature(new StringSignature(userModel._updateStamp))
                        ...
                        mGlideRequestManager.using(new FirebaseImageLoader()).load(storageReference.child(userModel._profileImage))
                                .signature(new StringSignature(userModel._updateStamp))
                                .placeholder(R.drawable.ic_action_loading_img)
